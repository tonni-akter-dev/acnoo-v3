...
const ServiceDetails = () => {
    return (
        <>
            ...
            <div className="container grid grid-cols-1 lg:grid-cols-2 gap-10 lg:px-0 md:px-5 px-4  pt-4 lg:pt-[60px] lg:mx-0 mx-5">
                <div>
                    <DetailsSection />
                    <div className='lg:hidden block'>
                        <Pricing />
                    </div>
                    <p className='lg:hidden  block text-[#6B7280] text-base font-medium lg:mt-0 mt-6'>
