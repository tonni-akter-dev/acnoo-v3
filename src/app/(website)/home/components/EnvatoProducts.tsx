...
const EnvatoProducts = () => {
    return (
        <div className='mt-[30px] lg_screen_px lg:px-[86px] px-4 lg:mb-[114px] mb-6 '>
            ...
            <Link href="/products">
                <motion.button variants={itemVariants} className="group mx-auto bg-[#2353F5] hover:text-[#2353F5] hover:bg-transparent border border-[#2353F5] flex gap-1.5 items-center text-white text-base font-bold lg:px-[36px] px-5 py-[13px] lg:py-[21px] rounded-[10px] w-fit transition-all duration-300">
                    View all Products
                    <svg
                        ...
                        viewBox="0 0 16 16"
                        fill="none"
                        className="transition-colors duration-300 group-hover:fill-[#2353F5]"
                    >
                        <path
                            ...
                            className="fill-white group-hover:fill-[#2353F5]"
                        />
                    </svg>
                </motion.button>
            </Link>
