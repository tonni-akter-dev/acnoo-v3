...
//             <div>
//                 <h1 className='text-[26px] md:text-[40px] lg:text-[72px] font-bold md:leading-[50px] lg:leading-[72px] leading-[34px] whitespace-nowrap mb-3 md:mb-4 lg:mb-5'>
//                     POS SAAS 
//                     <span className='flutter_app_text text-red ms-2'>
//                          Flutter APP
//                         <span className="flutter-underline w-full">
//                             <Image src={flutter} alt="underline"  
//                             className='w-full'/>
//                         </span>
//                     </span> <br />
//                     web for Super Shop
        ...
        >
            ...
            <motion.div variants={itemVariants}>
                <motion.h1
                    ...
                    className='text-[26px] md:text-[40px] lg:text-[72px] font-bold md:leading-[50px] lg:leading-[72px] leading-[34px] whitespace-nowrap mb-3 md:mb-4 lg:mb-5'
                >
                    POS SAAS
                    <motion.span
                        variants={itemVariants}
                ...
                <motion.p
                    variants={itemVariants}
                    className='text-[#6B7280] text-base lg:text-lg font-medium mb-6 lg:mb-[30px]'
                >
                    Acnoo is a fully featured dashboard and admin template comes with tones of well designed
                    <br className='xl:block lg:hidden md:hidden hidden' />
