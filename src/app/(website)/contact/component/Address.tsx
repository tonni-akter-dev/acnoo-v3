    ...
    return (
        <div className="address mt-5 lg:mt-[120px] lg:mx-0 md:mx-5">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-8">
                <div className='group bg-[#F3F3FF] rounded-lg hover:bg-[#2F1C6A] border text-center flex flex-col items-center border-white py-5 lg:py-[60px] px-3 lg:px-20 transition-all duration-300'>
