...
const SupportCard: React.FC<SupportCardProps> = ({ Icon, title, description }) => (
   <div className="bg-[#EBF5FE] hover:bg-[#2F1C6A] hover:text-white rounded-xl pt-8 md:pt-16  pb-[54px] px-8 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100 group become_card_parent">
      ...
      <h2
         className="text-2xl font-semibold text-gray-800 lg:mt-12 group-hover:text-white"
...
const UnlimitedSupport: React.FC = () => {
   return (
      <div className="containers become_partner_wrap mx-auto lg:py-12 lg:px-0 px-5">
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 become_partner_card">
