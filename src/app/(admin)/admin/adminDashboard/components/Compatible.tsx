...
// import pos from '/public/admindashboard/pospro1.png'
// import laravel from '/public/admindashboard/laravel.png'
// import ios from '/public/admindashboard/ios.png'
// import android from '/public/admindashboard/android.png'
// import flutter from '/public/admindashboard/flutter.png'
// import mysql from '/public/admindashboard/mysql.png'
...
const Compatible = () => {
    return (
        <div className='containers px-5 mt-9 bottom_grad lg:pb-[90px] pb-9'>
            <div className="grid grid-cols-1 lg:grid-cols-2 compatible_wrapppers items-start">
                {/* Text Section */}
                <div className=''>
                    <p className='text-red text-sm lg:text-base uppercase font-bold mb-2.5 lg:mb-3.5'>Compatible with</p>
                    <h2 className='text-2xl md:text-[30px] heading_text lg:text-[60px] text-[#0B071A] font-bold leading-8 lg:leading-[56px] mb-3 lg:mb-5'>
                        POSpro compatible with
                    </h2>
                    <p className='text-base lg:text-lg mb-6 text-[#4B5563] font-medium'>
                        The layout is responsive and looks gorgeous and <br className='br_compatible' />
                        professional on any major devices and this theme <br className='br_compatible' />
                        comes with custom page templates.
                    </p>
                    <div className='flex  com_btn gap-4 lg:gap-5 items-center '>
                        <button className="bg-red flex gap-1.5 items-center text-white text-sm lg:text-base font-bold px-5 lg:px-[36px] py-[14px] lg:h-[60px] h-12 whitespace-nowrap rounded-sm lg:rounded-[10px] w-fit border border-red transition-all duration-300 group hover:bg-transparent hover:text-red">
                            Browse Frontend
                ...
                {/* Circular Layout */}
                <div className="relative com_wrap_parent w-[360px] h-[360px] md:w-[500px]  md:h-[500px] mx-auto">
                    {/* Outer Circular Border */}
                    <div className="absolute top-1/2 left-1/2 size-[490px] rounded-full border-[1.5px] border-[#F5ECF4] -translate-x-1/2 -translate-y-1/2 z-10 flex justify-center items-center compatible_border2">
                        {/* Inner Circular Border */}
                        <div className="size-[400px] rounded-full border-[1.5px] border-[#F5ECF4] flex justify-center items-center compatible_border1">
                            <Image src={pos} alt="POSpro" className="size-[238px] object-contain pos_pro_img" />
                        </div>
                    </div>
