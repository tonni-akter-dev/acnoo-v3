...
import free from "/public/img/free.png";
import Image from "next/image";
import DownloadViewDetails from "./DownloadViewDetails";
            ...
            <React.Fragment key={data}>
              <tr className="font-body-3">
                ...
                <td className="font-body-3 d-flex align-items-center justify-content-center">
                  <button className=" download-btn d-flex gap-1 align-items-center justify-content-center">
                ...
                <td className="print-d-none">
                  <div className="dropdown table-action">
                    <button
                      ...
                      data-bs-target="#freeViewModal"
                      className="font-body-3 view-details-btn gap-1 d-flex  align-items-center font-medium  "
                      aria-expanded="false"
                    >
                      ...
                      >
                        <path
                          d="M8.00016 0.833496C4.04816 0.833496 0.833496 4.04816 0.833496 8.00016C0.833496 11.9522 4.04816 15.1668 8.00016 15.1668C11.9522 15.1668 15.1668 11.9522 15.1668 8.00016C15.1668 4.04816 11.9522 0.833496 8.00016 0.833496ZM8.00016 14.1668C4.5995 14.1668 1.8335 11.4008 1.8335 8.00016C1.8335 4.5995 4.5995 1.8335 8.00016 1.8335C11.4008 1.8335 14.1668 4.5995 14.1668 8.00016C14.1668 11.4008 11.4008 14.1668 8.00016 14.1668ZM9.68685 7.64681C9.88218 7.84214 9.88218 8.15883 9.68685 8.35417L7.68685 10.3542C7.58952 10.4515 7.4615 10.5008 7.3335 10.5008C7.2055 10.5008 7.07748 10.4522 6.98014 10.3542C6.78481 10.1588 6.78481 9.84214 6.98014 9.64681L8.62679 8.00016L6.98014 6.35352C6.78481 6.15818 6.78481 5.84149 6.98014 5.64616C7.17548 5.45083 7.49217 5.45083 7.6875 5.64616L9.68685 7.64681Z"
                          fill="#0B071A"
                        />
                      </svg>
                    </button>
