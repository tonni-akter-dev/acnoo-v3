...
const BecomePartnerBanner = () => {
   return (
      <div className='service service-bg relative'>
         <div className='container py-5 md:py-8 lg:py-[100px] lg:px-[100px] px-5 ' >
            <h2 className='text-3xl md:text-[55px] lg:text-[120px] text-[#1A0B49] font-bold leading-10 md:leading-[65px] lg:leading-28 capitalize mb-3 md:mb-6 lg:mb-12'>become a acnoo <br /> partner</h2>
