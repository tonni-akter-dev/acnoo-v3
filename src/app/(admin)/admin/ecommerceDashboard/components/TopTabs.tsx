...
const tabs = [
    {
        id: 'overview', label: 'Overview', content: <EcommerceOverview />,
    },
    {
...
const TopTabs = () => {
    ...
    return (
        <div className='border-t border-[#D9D9D9]'>
            <div className='flex lg:flex-row flex-col lg:gap-0 md:gap-3 gap-6 justify-between lg:px-[150px]  py-3 pb-0 md:pt-5 lg:py-9 top_heading_dash' style={{ boxShadow: '0px 7px 34px 0px rgba(0, 0, 0, 0.02)' }}>
                <div className='lg:px-0 px-5'>
                    <p className='text-[#4B5563] text-base  md:text-lg  lg:text-lg font-bold border-l-[2px] border-[#D9D9D9] ps-2 '>POS SAAS - Flutter POS Billing Inventory Software</p>
                </div>  
