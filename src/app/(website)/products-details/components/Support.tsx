...
const Support = () => {
    ...
    return (
        <div>
            {/* Support header with image */}
            <motion.div
                className="flex overflow-hidden justify-between relative items-center rounded support-bg"
                initial="hidden"
                animate="visible"
            ...
            >
                <div className="flex gap-2.5 lg:gap-4 items-center">
                    ...
                    <div className="text-white">
                        <h1 className="text-base md:text-2xl lg:text-[28px] font-bold">
                            Acnoo Support This Item
                        </h1>
                        <p className="text-[13px] lg:text-lg">6 month free support</p>
                    </div>
                </div>
                <Image
                    className="lg:right-0 md:right-0 absolute right-[-54px]"
                    src={man}
                    alt=""
                />
            </motion.div>
            ...
            <motion.div
                className="py-5 px-6 lg:px-7 lg:py-6 border mt-6 border-[#EAEAEA] rounded-[12px]"
                initial="hidden"
                animate="visible"
                transition={{ staggerChildren: 0.2 }} // stagger children animations
            >
                <motion.div variants={fadeIn}>
                    <h1 className="text-base md:text-[22px] lg:text-[22px] text-primary font-bold">
                        Contact The Author
                    </h1>
                    <p>
                ...
                <motion.div variants={slideInLeft} className="mt-5 lg:mt-6">
                    <h1 className="text-base md:text-[22px] lg:text-[22px] text-primary font-bold mb-2">
                        What We Will Support
                    </h1>
                    <ul>
                        {[
                            "Availability of the customer to answer questions",
                            ...
                            <motion.li
                                key={i}
                                className="flex items-center gap-2 text-sm lg:text-base text-[#4B5563]"
                ...
                <motion.div variants={slideInRight} className="mt-6">
                    <h1 className="text-base md:text-[22px] lg:text-[22px] text-primary font-bold mb-2">
                        However, item support does not include
                    </h1>
                    <ul>
                        {["Customization services", "Installation service"].map((text, i) => (
                            <motion.li
                                key={i}
                                className="flex items-center gap-2 text-sm lg:text-base text-[#4B5563]"
                                variants={fadeIn}
                ...
                <motion.div
                    className="flex md:flex-row flex-col-reverse gap-2.5 md:gap-5 lg:gap-7 mt-6"
                    variants={fadeIn}
                >
                    <button className="w-full lg:h-14 h-12 hover:bg-[#2F1C6A] hover:text-white text-[#2F1C6A] text-lg font-bold border border-[#2F1C6A] bg-none rounded-[6px] transition ease-in-out duration-300 ">
                        Read item support policy
                    </button>
                    <button className="w-full lg:h-14 h-12  text-white text-lg font-bold  hover:bg-transparent border border-[#2F1C6A] hover:text-[#2F1C6A] bg-[#2F1C6A] rounded-[6px] transition ease-in-out duration-300 ">
                        Go to item Support
                    </button>
                </motion.div>
            </motion.div>
