            ...
            <div className='mx-4 sm:mx-auto  pb-6    relative overflow-hidden'>
                <div className='text-center lg:px-0 relative  flex flex-col  items-center justify-center '>
                    ...
                    >
                        ...
                        <button
                            className="group mx-auto bg-[#2353F5] hover:text-[#2353F5] hover:bg-transparent border border-[#2353F5] flex gap-1.5 items-center text-white text-base font-bold lg:px-[36px] px-5 py-[13px] lg:py-[21px] rounded-[10px] w-fit transition-all duration-300"                        >
                            Contact with us
                            <svg
