    ...
    return (
        <div className='rounded-xl  bg-white ' style={{ boxShadow: "0px 2px 23px -5px rgba(18, 18, 18, 0.09)" }}>
            <div className='relative group'>
                <Image className='h-[273px] card_image mb-4 lg:mb-[33px] w-full transition-transform duration-300 ' src={product1} alt="" />
            ...
            <div className='lg:ps-[30px] lg:pb-[30px] lg:pe-10 px-4 pb-5 card_description'>
                <h4 className='text-primary text-lg font-bold mb-[14px] lg:mb-4 truncate'>
                    POS pro - POS Inventory Flutter App...
                </h4>
                <p className='text-[#3B4758] text-lg font-bold flex gap-2 items-center pb-3 lg:pb-6 border-b border-[#E7ECF8]'>$120 <span className='text-[#6B7280] text-sm font-medium '>$149</span></p>
                <div className='flex justify-between items-center mt-[14px] lg:mt-6'>
                    <p>800 Sales</p>
