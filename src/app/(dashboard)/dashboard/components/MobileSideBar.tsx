            ...
            <div  className="offcanvas offcanvas-start" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                ...
                <div className="offcanvas-body">
                    <div style={{position: 'relative', zIndex: "999999999"}}>
                        <nav className={`side-bar1 z-[9999]`} >
                            <div className="side-bar-logo flex justify-between items-center border-b">
                                <Link href="javascript:void(0)">
                                    <Image src={acnoo} alt="Logo" />
                                </Link>
                                <button type="button" className=" text-white size-8" data-bs-dismiss="offcanvas" aria-label="Close">
