...
const Trusted = () => {
  ...
  const wrapperStyle = 'border border-[#B3B3B3] bg-[#fbfdff] h-[50px] md:h-[63px] lg:h-[112px] lg:w-[195px] md:w-[146px] w-[114px] flex justify-center items-center px-[20px] md:px-10 lg:px-11 rounded-lg'
  const shadowStyle = { filter: 'drop-shadow(0px 24px 16px rgba(16, 23, 54, 0.03))' }
  const imageStyle = 'object-contain '

  return (
    <div className='pt-7 pb-10 md:pt-11 md:pb-[30px]  lg:py-[120px]'>
      ...
      <div className='space-y-[9px] md:space-y-3 lg:space-y-8'>
        <Marquee>
          <div className='flex gap-[9px] md:gap-3  lg:gap-[30px] items-center me-[9px] md:me-3 lg:me-[30px]'>
            {firstRow.map((img, i) => (
