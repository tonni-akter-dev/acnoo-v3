...
const ServiceRefundModal = () => {
  return (
    <div className="modal fade" id="serviceRefundModal" aria-hidden="true">
        ...
        <div className="modal-content">
            ...
            <div className="modal-body">
                <form className="px-2 refund-form">
                    ...
                    <div className="bkash-fields mb-3" id="bkashFields">
                        <div className="row">
...
export default ServiceRefundModal