...
const Automation = () => {
  return (
    <div className="lg:px-[86px] px-5 mn-[112px]">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-3 md:gap-[18px] lg:gap-11 automation_wrap">
          ...
          <div
            ...
            <div className="relative overflow-hidden mb-5">
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
                <button className="bg-[#2F1C6A] cursor-pointer text-white px-4 py-2 font-bold rounded-md">
                  Live Preview
                </button>
              </div>
