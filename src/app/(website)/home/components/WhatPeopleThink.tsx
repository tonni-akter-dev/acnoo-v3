        ...
        <div className="lg:py-16 md:py-8 py-6 whatpeoplethink_wrapper relative  z-50">
            ...
            <div className=" mx-auto">  
                <div className="flex justify-between items-center mb-8 lg_screen_px lg:px-[150px] px-5">
                    ...
                    <button className="cursor-pointer bg-[#2F1C6A] hidden lg:flex gap-1.5 items-center text-white text-base font-bold px-[36px] py-[21px] rounded-[10px] w-fit">
                ...
                >
                    <SwiperSlide>
                        <div className="bg-white border lg:mx-0 md:mx-0 mx-4 border-[#838BB424]  md:max-w-[616px] lg:max-w-[888px]  flex md:flex-row lg:flex-row flex-col-reverse md:justify-between  gap-2.5 md:gap-[31px] lg:gap-[38px] rounded-[12px] lg:rounded-[30px] shadow-md items-stretch md:items-center   lg;items-center md:p-4 lg:p-7 p-2">
