...
const EnvatoProducts = () => {
    return (
        <div className='mt-[30px] lg_screen_px lg:px-[86px] px-4 lg:mb-[114px] mb-6 '>
            ...
            <Link href={'/products'}>   <button className="mx-auto bg-[#2353F5] flex gap-1.5 items-center text-white text-base font-bold lg:px-[36px] px-5 py-[13px] lg:py-[21px] rounded-[10px] w-fit">
                View all Products <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
