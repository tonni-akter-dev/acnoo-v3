            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 items-end innovative">
                <div>
                    ...
                    <div className='relative mb-4 md:mb-0 lg:mb-12 lg:px-0 px-5 '>
                        <h1 className='text-xl md:text-2xl lg:text-[50px]  uppercase font-bold leading-[30px] md:leading-8 lg:leading-[60px]  text-primary'>We <span className='font-medium'>specialize</span> in building <br />
                            Website & apps </h1>
                        <Image className='absolute bottom-[-10px] ' src={vector} alt="" />
                    </div>
                    <div className='lg:px-0 px-5 flex lg:flex-row md:flex-row flex-col-reverse items-start md:items-end  lg:items-center gap-5'>
                        ...
                        <div className='h-[102px] w-[1px] bg-[#59595CA1] rounded-[11px] lg:block md:block hidden'></div>

                        <p>It has stood the test of time and proceeds <br />
                            to advance – an great arrangement for our <br />
                            skilled creative group, who proceed to <br />
                ...
                <div className='flex gap-2 md:gap-3 lg:gap-7 md:justify-end relative lg:mt-0 mt-7'>
                    ...
                    <Image className=' block lg:block  md:hidden md:h-[284px] lg:h-[605px]' src={team2} alt="" />
                    <Image className=' block lg:block  md:hidden md:h-[284px] lg:h-[605px]' src={team3} alt="" />
                    <Image className=' lg:hidden md:block hidden md:h-[284px] lg:h-[605px]' src={innovativetab1} alt="" />
                    <Image className=' lg:hidden md:block hidden md:h-[284px] lg:h-[605px]' src={innovativetab2} alt="" />
                </div>
            </div>
        </div>
    )
